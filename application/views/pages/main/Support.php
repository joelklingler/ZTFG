...
Wir sind zu erreichen über:<br><br><br><br>

<img src="<?php echo asset_url()."/img/mail.png"; ?>" align="middle"><br><br>
 <a href="mailto:support@ztfg.de" style="color: red">Support@ZTFG.de</a><br><br><br>
<img src="<?php echo asset_url()."/img/ts.png"; ?>" align="middle" width="50"><br><br>
 <a href="ts3server://5.175.26.146/?port=9987&nickname=HomepageUser" style="color: red"> Connect</a><br><br><br>
